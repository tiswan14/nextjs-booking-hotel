...
const Card = ({ room }: { room: Room }) => {
    return (
        <div className="bg-white shadow-lg rounded-sm transition duration-100 hover:shadow-sm ">
            <div className="h-[260px] w-auto rounded-t-sm position-relative ">
                <Image src={room.image} width={384} height={256} alt="room image" className="w-fulll h-full object-cover rounded-t-sm"></Image>
            </div>
            <div className="p-8">
